...
const RaffleDonate = ({ history }) => {
  ...
  return (<>
    ...
    </main>
    {
      donateResponse
        ?
        createPortal(<DonationFinishModal clearRequestInterval={clearRequestInterval} modalStatus={modalStatus} response={donateResponse} />, document.getElementById('finish-modal'))
        :
        null
    }
  </>)
