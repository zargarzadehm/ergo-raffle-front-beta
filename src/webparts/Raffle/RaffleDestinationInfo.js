...
const RaffleDestinationInfo = memo(({raffle}) => {
    ...
    return (<>
        <div className="col-lg-5">
            <div
                className={raffle.status !== 'active' ? "donation-goal-box bordered-field" : "donation-goal-box bordered-field bordered-field-orange"}>
                <p className="total-donation">
                    Donation Goal:
                    <span className="total-donation-number"> <Erg erg={isNaN(raffle.goal) ? 0 : raffle.goal}
                                                                  shouldDisplay={true}/> </span>
                </p>
            </div>
            <div className="raffle-shares-box d-flex bordered-field">
                <div className="charity-share flex-grow-1">
                    <p>Charity: <span className="charity-share-text">{raffle.percent && raffle.percent.charity}%</span>
                    </p>
                </div>
