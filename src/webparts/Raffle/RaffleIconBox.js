...
const RaffleIconBox = memo(({raffle}) => {
    ...
    return (<div className="row">
        <div className="col-4 text-center">
            <span className="slider-icon raffle-icon"><img
                src={context.theme === DARK_THEME ? handHeartDark : handHeart} alt={'people donation'}/></span>
        ...
        <div className="col-4 text-center">
            <span className="slider-icon raffle-icon"><img src={context.theme === DARK_THEME ? piggyDark : piggy}
                                                           alt={'ticket price'}/></span>

            <p className="ico-text mt-2">
                <span className="people-number"><Erg shouldDisplay={false}
                                                     erg={((raffle.ticket && raffle.ticket.erg) || 0)}/></span><br/>
                ERG Collected
            </p>
        </div>
        <div className="col-4 text-center">
            <span className="slider-icon raffle-icon"><img src={context.theme === DARK_THEME ? ticketDark : ticket}
                                                           alt={'ticket sold'}/></span>
