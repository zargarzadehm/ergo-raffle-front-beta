...
const RaffleBarStep = memo(({activeStep, stepBarRef}) => {
    return (
        <div className="create-raffle-header mb-3">
            ...
            <div className="row my-2 step-circle-box">
                ...
                <div className="col-8 step-circle-container">
                    <div
                        className={activeStep >= 6 ? "step-circle step-2-circle step-active" : "step-circle step-2-circle"}/>
                </div>
                <div className="col-2 step-circle-container">
                    <div
                        className={activeStep >= 10 ? "step-circle step-3-circle step-active" : "step-circle step-3-circle"}/>
                </div>
            </div>
            <div className="row">
