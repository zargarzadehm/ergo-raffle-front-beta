const staticText = {
    ...
    raffleListTabs: ['All Raffles', 'Active', 'Successful', 'Failed'],
    navigations: [{title: 'Home', link:'/'},{title: 'All Raffles', link:'/raffle/list'},{title: 'FAQ', link:'/faq'},{title: 'About/Contact', link:'/about'},{title: 'Dashboard', link:'/dashboard'}],
